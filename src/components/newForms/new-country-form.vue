  ...
  <el-collapse v-model="activeNames" >
    <el-collapse-item name="1" >
      ...
      <el-form
          ...
          status-icon
      >
        <el-form-item label="nom du pays" prop="name">
          <el-input v-model="newCountryForm.name" />
        </el-form-item>
        <el-form-item label="code du pays" prop="code">
          <el-input v-model="newCountryForm.code" />
        </el-form-item>
        <el-form-item label="capital du pays" prop="capital">
          <el-input v-model="newCountryForm.capital" />
        </el-form-item>
        <el-form-item label="la monnaie du pays" prop="currency">
          <el-input v-model="newCountryForm.currency" />
        </el-form-item>
        <el-form-item label="le duminutif  du pays" prop="shortname">
          <el-input v-model="newCountryForm.shortname" />
        </el-form-item>
        <el-form-item>
